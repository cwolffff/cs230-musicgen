"""
Source: https://github.com/jason9693/midi-neural-processor/blob/master/processor.py
"""
...
def _merge_note(snote_sequence, debug=False):
    note_on_dict = {}
    result_array = []
    ...
    for snote in snote_sequence:
        if snote.type == 'note_on':
            ...
            try:
                ...
                if debug:
                    print(f'INFO: Removed event note_off_{snote.value}')
    return result_array
...
def decode_midi(idx_array, file_path=None):
    ...
    instument = pretty_midi.Instrument(1, False)
